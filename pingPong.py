...
class Ball(GameSprite):
    ...
    def move(self):
        ...
        self.img = transform.rotate(self.img, )
...
playerL = Player('SECOND.png',  25, 100, 5, 1)
playerR = Player('FIRST.png', 25, 100, 5, 2)
ball = Ball('BALLS.png', (maxX - 35)//2, (maxY - 35)//2, 35, 35, 3) 
